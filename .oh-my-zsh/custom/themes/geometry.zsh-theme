...
GEOMETRY_COLOR_USER=${GEOMETRY_COLOR_USER:-blue}
...
GEOMETRY_USER_HOST_PREFIX="%F{$GEOMETRY_COLOR_USER}$USER@$HOST"
...
prompt_geometry_render() {
  ...
  PROMPT="$GEOMETRY_USER_HOST_PREFIX %${#PROMPT_SYMBOL}{%(?.$GEOMETRY_PROMPT.$GEOMETRY_EXIT_VALUE)%} %F{$GEOMETRY_COLOR_DIR}%3~%f "
